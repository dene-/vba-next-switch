...
void Clickable::draw(float font)
{
    ...
    drawRect(mx, my, mw, mh, mColorBg);
    drawTextTruncate(font, mx + (mw - messageWidth)/2, my + (mh - texth)/2, mColorText, mw - 4*2 - 40 - dotlen, "...", mText.c_str());*/
}